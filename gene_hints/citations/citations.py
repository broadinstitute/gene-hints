...
def split_ncbi_file_by_org(input_path, output_filename, organisms):
...
def fetch_all_publications_over_time(path, prev_path, num_days):
...
def fetch_all_publications_per_organism(organisms):
    ...
    split_ncbi_file_by_org(output_path, output_filename, organisms)

def fetch_genome_annotations(organisms):
...
def download_data(pmid_dates_path, prev_pmid_dates_path, num_days):
    ...
    # Download IDs for articles published in the last `num_days`
    fetch_all_publications_over_time(
...
def gene_citations(num_days):
    ...
    download_data(pmid_dates_path, prev_pmid_dates_path, num_days)
