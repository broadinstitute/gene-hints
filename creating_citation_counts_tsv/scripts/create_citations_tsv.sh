...
mkdir creating_citation_counts_tsv/data/mosquito
...
# Getting Mosquito gene2pubmed
cat creating_citation_counts_tsv/data/gene2pubmed | awk '{if ($1 == 7165) print;}' > creating_citation_counts_tsv/data/mosquito/gene2pubmed
...
# Getting Mosquito refences file
wget -N -P creating_citation_counts_tsv/data/mosquito https://hgdownload.soe.ucsc.edu/goldenPath/dm6/bigZips/genes/dm6.refGene.gtf.gz
gunzip -f creating_citation_counts_tsv/data/mosquito/dm6.refGene.gtf.gz
...
# Getting Mosquito gene_info
cat creating_citation_counts_tsv/data/gene_info | awk '{if ($1 == 7165) print;}' > creating_citation_counts_tsv/data/mosquito/gene_info
